...
/**
 * Threads background component with WebGL animation
 * Supports theme-aware colors (light mode: white lines, dark mode: black lines)
 */
export default function Threads({
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uColor: { value: new Color(...effectiveColor) },
  ...
  }, [effectiveColor, amplitude, distance, enableMouseInteraction, theme]);

  return <div ref={containerRef} className="threads-background absolute inset-0 -z-10" {...rest} />;
}
