...
func TestVersion_ConcurrentAccess(t *testing.T) {
	testutils.Run(t, testutils.Level1, "TestVersion_ConcurrentAccess", nil, func(t *testing.T, tx *gorm.DB) {
...
func TestVersion_Caching(t *testing.T) {
	testutils.Run(t, testutils.Level1, "TestVersion_Caching", nil, func(t *testing.T, tx *gorm.DB) {
...
func TestVersion_GitFallback(t *testing.T) {
	testutils.Run(t, testutils.Level1, "TestVersion_GitFallback", nil, func(t *testing.T, tx *gorm.DB) {
...
func TestVersion_WithTagsInGitRepo(t *testing.T) {
	testutils.Run(t, testutils.Level1, "TestVersion_WithTagsInGitRepo", nil, func(t *testing.T, tx *gorm.DB) {
		if testing.Short() {
...
func TestVersion_WithMultipleTags(t *testing.T) {
	testutils.Run(t, testutils.Level1, "TestVersion_WithMultipleTags", nil, func(t *testing.T, tx *gorm.DB) {
		if testing.Short() {
			t.Skip("skipping git-dependent test in short mode")
		}
...
func TestVersion_InvalidGitEnv(t *testing.T) {
	testutils.Run(t, testutils.Level1, "TestVersion_InvalidGitEnv", nil, func(t *testing.T, tx *gorm.DB) {
...
func TestDefaultVersionConstant(t *testing.T) {
	testutils.Run(t, testutils.Level1, "TestDefaultVersionConstant", nil, func(t *testing.T, tx *gorm.DB) {
...
func TestVersionRaceCondition(t *testing.T) {
	testutils.Run(t, testutils.Level1, "TestVersionRaceCondition", nil, func(t *testing.T, tx *gorm.DB) {
...
func TestVersion_LongRunningConsistency(t *testing.T) {
	testutils.Run(t, testutils.Level1, "TestVersion_LongRunningConsistency", nil, func(t *testing.T, tx *gorm.DB) {
		// Get initial version
...
func TestVersionCrossPlatform(t *testing.T) {
	testutils.Run(t, testutils.Level1, "TestVersionCrossPlatform", nil, func(t *testing.T, tx *gorm.DB) {
