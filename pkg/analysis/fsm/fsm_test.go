...
func TestGraphFSM_StateTransitions(t *testing.T) {
	testutils.Run(t, testutils.Level1, "GraphFSM_StateTransitions", nil, func(t *testing.T, _ *gorm.DB) {
...
func TestGraphFSM_ErrorHandling(t *testing.T) {
	testutils.Run(t, testutils.Level1, "GraphFSM_ErrorHandling", nil, func(t *testing.T, _ *gorm.DB) {
		logger := common.NewLogger(os.Stdout, "test", common.InfoLevel)
		fsm := NewGraphFSM(logger)
...
func TestGraphFSM_EventEmission(t *testing.T) {
	testutils.Run(t, testutils.Level1, "GraphFSM_EventEmission", nil, func(t *testing.T, _ *gorm.DB) {
		logger := common.NewLogger(os.Stdout, "test", common.InfoLevel)
		fsm := NewGraphFSM(logger)
...
func TestAnalyzeFSM_Lifecycle(t *testing.T) {
	testutils.Run(t, testutils.Level1, "AnalyzeFSM_Lifecycle", nil, func(t *testing.T, _ *gorm.DB) {
		logger := common.NewLogger(os.Stdout, "test", common.InfoLevel)
...
func TestAnalyzeFSM_GraphEventHandling(t *testing.T) {
	testutils.Run(t, testutils.Level1, "AnalyzeFSM_GraphEventHandling", nil, func(t *testing.T, _ *gorm.DB) {
		logger := common.NewLogger(os.Stdout, "test", common.InfoLevel)
		fsm := NewAnalyzeFSM(logger)
		...
		// Complete build (should transition back to IDLE)
...
func TestAnalyzeFSM_ResourceConstrained(t *testing.T) {
	testutils.Run(t, testutils.Level1, "AnalyzeFSM_ResourceConstrained", nil, func(t *testing.T, _ *gorm.DB) {
		logger := common.NewLogger(os.Stdout, "test", common.InfoLevel)
		fsm := NewAnalyzeFSM(logger)
