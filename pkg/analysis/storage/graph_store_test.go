...
func TestGraphStore_SaveAndLoad(t *testing.T) {
	testutils.Run(t, testutils.Level1, "GraphStore_SaveAndLoad", nil, func(t *testing.T, _ *gorm.DB) {
...
func TestGraphStore_Checkpoint(t *testing.T) {
	testutils.Run(t, testutils.Level1, "GraphStore_Checkpoint", nil, func(t *testing.T, _ *gorm.DB) {
		logger := common.NewLogger(os.Stdout, "test", common.WarnLevel)
