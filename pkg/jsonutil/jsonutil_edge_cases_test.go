...
func TestUnmarshalFunctionality(t *testing.T) {
	testutils.Run(t, testutils.Level1, "TestUnmarshalFunctionality", nil, func(t *testing.T, tx *gorm.DB) {
		tests := []struct {
			name     string
			input    string
			expected interface{}
...
func TestUnmarshalErrorConditions(t *testing.T) {
	testutils.Run(t, testutils.Level1, "TestUnmarshalErrorConditions", nil, func(t *testing.T, tx *gorm.DB) {
		tests := []struct {
			name  string
			input string
		}{
...
func TestNestedStructures(t *testing.T) {
	testutils.Run(t, testutils.Level1, "TestNestedStructures", nil, func(t *testing.T, tx *gorm.DB) {
...
func TestPerformanceWithLargeDocuments(t *testing.T) {
	testutils.Run(t, testutils.Level1, "TestPerformanceWithLargeDocuments", nil, func(t *testing.T, tx *gorm.DB) {
...
func TestEdgeCasesWithSpecialCharacters(t *testing.T) {
	testutils.Run(t, testutils.Level1, "TestEdgeCasesWithSpecialCharacters", nil, func(t *testing.T, tx *gorm.DB) {
		tests := []struct {
			name     string
			input    interface{}
			expected string
...
func TestMarshalIndentWithVariousInputs(t *testing.T) {
	testutils.Run(t, testutils.Level1, "TestMarshalIndentWithVariousInputs", nil, func(t *testing.T, tx *gorm.DB) {
		tests := []struct {
			name  string
			input interface{}
		}{
