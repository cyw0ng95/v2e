...
func TestRPCGetCVEByID(t *testing.T) {
	...
	testutils.Run(t, testutils.Level1, "Get existing CVE", nil, func(t *testing.T, tx *gorm.DB) {
		// Create request message
		payload, _ := subprocess.MarshalFast(map[string]string{
	...
	testutils.Run(t, testutils.Level1, "Get non-existing CVE", nil, func(t *testing.T, tx *gorm.DB) {
		// Create request message
		payload, _ := subprocess.MarshalFast(map[string]string{
	...
	testutils.Run(t, testutils.Level1, "Empty CVE ID", nil, func(t *testing.T, tx *gorm.DB) {
		// Create request message
		payload, _ := subprocess.MarshalFast(map[string]string{
			"cve_id": "",
		})
...
func TestRPCDeleteCVEByID(t *testing.T) {
	...
	testutils.Run(t, testutils.Level1, "Delete existing CVE", nil, func(t *testing.T, tx *gorm.DB) {
	...
	testutils.Run(t, testutils.Level1, "Delete non-existing CVE", nil, func(t *testing.T, tx *gorm.DB) {
		// Create request message
		payload, _ := subprocess.MarshalFast(map[string]string{
...
func TestRPCListCVEs(t *testing.T) {
	...
	testutils.Run(t, testutils.Level1, "List with default pagination", nil, func(t *testing.T, tx *gorm.DB) {
	...
	testutils.Run(t, testutils.Level1, "List with custom pagination", nil, func(t *testing.T, tx *gorm.DB) {
	...
	testutils.Run(t, testutils.Level1, "List with offset beyond total", nil, func(t *testing.T, tx *gorm.DB) {
