...
// PerformanceOptimizer provides performance enhancements for the broker
...
// NewPerformanceOptimizer creates a new performance optimizer for the broker
func NewPerformanceOptimizer(b *Broker) *PerformanceOptimizer {
...
func (opt *PerformanceOptimizer) startWorkerPool() {
...
func (opt *PerformanceOptimizer) messageProcessor(workerID int) {
...
func (opt *PerformanceOptimizer) updateAtomicStats(msg *proc.Message, isSent bool) {
	if isSent {
...
func (opt *PerformanceOptimizer) syncStats() {
	go func() {
		for {
			select {
...
func (opt *PerformanceOptimizer) SendMessageOptimized(msg *proc.Message) error {
...
func (opt *PerformanceOptimizer) GetOptimizedStats() MessageStats {
...
func (opt *PerformanceOptimizer) Start() {
	opt.syncStats()
...
func (opt *PerformanceOptimizer) ApplyToBroker() {
...
func (opt *PerformanceOptimizer) GetPerformanceMetrics() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"gc_runs":                  "unavailable", // runtime.NumGC() would require additional import
